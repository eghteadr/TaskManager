<nav class="bg-white shadow-lg lg:block hidden">
    <ul class="space-y-4 p-6">
        ...
        <li>
            <a href="{{ route('supervisor.dashboard') }}" class="block p-4 rounded-lg hover:bg-gray-200">پروژه های من</a>
        </li>
        <li>
            <a href="{{ route('supervisor.dashboard') }}" class="block p-4 rounded-lg hover:bg-gray-200">تسک ها</a>
        </li>
